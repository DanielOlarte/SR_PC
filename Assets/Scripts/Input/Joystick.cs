			...
			for(int i = 0;i < count; i++)
			{
				...
				{	
					...
					{					
						...
						Rect tempPixelInset = gui.pixelInset;
						tempPixelInset.x =  Mathf.Clamp( guiTouchPos.x, guiBoundary.min.x, guiBoundary.max.x );
						tempPixelInset.y =  Mathf.Clamp( guiTouchPos.y, guiBoundary.min.y, guiBoundary.max.y );	
						
						gui.pixelInset = tempPixelInset;
					}
